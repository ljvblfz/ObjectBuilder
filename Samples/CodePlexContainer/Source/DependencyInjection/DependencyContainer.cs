...
namespace CodePlex.DependencyInjection
{
    public class DependencyContainer : IObjectFactory, IDisposable
    {
        ...
        {
            builder.Policies.Set<ISingletonPolicy>(new SingletonPolicy(true), typeof(T), null);
        }
        ...
        public void RegisterTypeMapping(Type typeRequested,
                                        Type typeToBuild)
        {
            builder.Policies.Set<ITypeMappingPolicy>(new TypeMappingPolicy(typeToBuild, null), typeRequested, null);
        }
