...
namespace CodePlex.DependencyInjection.ObjectBuilder
{
    public partial class ObjectBuilderXmlConfig : IBuilderConfigurator<BuilderStage>
    {
        ...
        void ProcessMappedType(BuildRule buildRule,
                               Type buildType)
        {
        ...
        void ProcessProperties(BuildRule buildRule,
                               Type buildType)
        {
        ...
        void ProcessSingleton(BuildRule buildRule,
                              Type buildType)
        {
        ...
        void ProcessConstructor(BuildRule buildRule,
                                Type buildType)
        {
        ...
        static IParameter GetParameterFromConfigParam(object param)
        {
        ...
        static IParameter RefParamToParameter(RefParam refParam)
        {
            Type paramType = Type.GetType(refParam.type);
            return new CreationParameter(paramType, refParam.name);
        }

        static IParameter ValueParamToParameter(ValueParam valueParam)
        {
        ...
        static ObjectBuilderXmlConfig ParseXmlConfiguration(string config)
        {
            ...
            XmlSchema schema =
                XmlSchema.Read(
                    Assembly.GetExecutingAssembly().GetManifestResourceStream(
                        "CodePlex.DependencyInjection.ObjectBuilder.Configuration.ObjectBuilderXmlConfig.xsd"), null);
